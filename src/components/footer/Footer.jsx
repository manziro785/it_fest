        ...
        <div className="wrapper-container-footer">
          <div className="footer">
            <div className="up-footer">
              <div className="left-footer">
                ...
                <div className="adress-footer">
                  ...
                  <div>
                    ...
                    <span>
                      <a
                        href="https://2gis.kg/bishkek/firm/70000001062985592"
                        target="_blank"
                      >
                        Пансионат Baytur Resort & SPA
                      </a>
                    </span>
                    ...
                    {isCopied && (
                      <div className="wrapper-message">
                        <div className="copy-message">
                          <img
                            src="./src/assets/common/icon (3).svg"
                            alt=""
              ...
              <div className="right-footer">
                <div className="creator-footer">
                  <div className="title-creator">Организатор мероприятия</div>
            ...
            <div className="down-footer">
              ...
              <div className="date-footer">©IT FESTIVAL 2024</div>
            </div>
          </div>
        </div>
      </div>
